...
func ifElseStatementsForGPSHeights (gpscoord: CLLocationCoordinate2D?, subharmonic: String) {
    let tidalHeightsQueryModel = TidalHeightsQueryModel()
    
    if Float(gpscoord?.latitude ?? 0) < 40.66912 && Float(gpscoord?.latitude ?? 0) > 40.587279 && Float(gpscoord?.longitude ?? 0) > -74.10612 && Float(gpscoord?.longitude ?? 0) < -73.98512 {
        tidalHeightsQueryModel.retrieveTidesForDisplay(harmonicStationString: "HEIGHTUSCGStation(8519050)LAT4060194LON-7405167")
    } else if Float(gpscoord?.latitude ?? 0) < 40.6526 && Float(gpscoord?.latitude ?? 0) > 40.5949 && Float(gpscoord?.longitude ?? 0) > -74.2035 && Float(gpscoord?.longitude ?? 0) < -73.994623 {
    ...
    } else if Float(gpscoord?.latitude ?? 0) < 40.76357 && Float(gpscoord?.latitude ?? 0) > 40.66912 && Float(gpscoord?.longitude ?? 0) > -74.08729 && Float(gpscoord?.longitude ?? 0) < -74.00076 {
        tidalHeightsQueryModel.retrieveTidesForDisplay(harmonicStationString: "HEIGHTTheBattery(8518750)LAT407LON-740025")
    } else if Float(gpscoord?.latitude ?? 0) < 40.715242 && Float(gpscoord?.latitude ?? 0) > 40.698782 && Float(gpscoord?.longitude ?? 0) > -74.00076 && Float(gpscoord?.longitude ?? 0) < -73.97496 {
        tidalHeightsQueryModel.retrieveTidesForDisplay(harmonicStationString: "HEIGHTBrooklynBridge(8517847)LAT4070056LON-73985278")
    } else if Float(gpscoord?.latitude ?? 0) < 40.724971 && Float(gpscoord?.latitude ?? 0) > 40.715242 && Float(gpscoord?.longitude ?? 0) > -73.97496 && Float(gpscoord?.longitude ?? 0) < -73.95743923 {
    ...
    } else if Float(gpscoord?.latitude ?? 0) < 40.76799432232893 && Float(gpscoord?.latitude ?? 0) > 40.724971 && Float(gpscoord?.longitude ?? 0) > -73.96356351064199 && Float(gpscoord?.longitude ?? 0) < -73.93889 {tidalHeightsQueryModel.retrieveTidesForDisplay(harmonicStationString: "HEIGHTQueensboroBridge(8518687)LAT40751389LON-7395138")
    } else if Float(gpscoord?.latitude ?? 0) < 40.78572 && Float(gpscoord?.latitude ?? 0) > 40.767994322 && Float(gpscoord?.longitude ?? 0) > -73.95206 && Float(gpscoord?.longitude ?? 0) < -73.91717 {
        tidalHeightsQueryModel.retrieveTidesForDisplay(harmonicStationString: "HEIGHTHornsHook(8518668)LAT407683LON-7393472")
    } else if Float(gpscoord?.latitude ?? 0) < 40.80288 && Float(gpscoord?.latitude ?? 0) > 40.78572 && Float(gpscoord?.longitude ?? 0) > -73.94521 && Float(gpscoord?.longitude ?? 0) < -73.91112 {
        tidalHeightsQueryModel.retrieveTidesForDisplay(harmonicStationString: "HEIGHTRandallsIsland(8518643)LAT408LON-7391861")
    } else if Float(gpscoord?.latitude ?? 0) < 40.827655 && Float(gpscoord?.latitude ?? 0) > 40.78572 && Float(gpscoord?.longitude ?? 0) > -73.91112 && Float(gpscoord?.longitude ?? 0) < -73.80903 {
        tidalHeightsQueryModel.retrieveTidesForDisplay(harmonicStationString: "HEIGHTPortMorris(8518639)LAT40800278LON-739011")
    } else if Float(gpscoord?.latitude ?? 0) < 40.78572 && Float(gpscoord?.latitude ?? 0) > 40.7457166 && Float(gpscoord?.longitude ?? 0) > -73.8739028 && Float(gpscoord?.longitude ?? 0) < -73.831424 {
